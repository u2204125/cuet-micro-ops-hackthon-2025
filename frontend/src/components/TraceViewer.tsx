    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
                ...
                <div className="space-y-3">
                    ...
                    <div className="bg-purple-50 p-3 rounded border border-purple-100">
                        <div className="flex items-center justify-between mb-1">
                            <span className="text-xs font-medium text-purple-700">Active Trace ID</span>
                            <button
                                onClick={copyTraceId}
                    ...
                    <div className="bg-blue-50 p-3 rounded border border-blue-100">
                        <div className="text-xs font-medium text-blue-700 mb-1">Current Span ID</div>
                    ...
                    <div className="p-3 bg-gray-50 rounded border border-gray-200 text-xs space-y-2">
                        <div className="font-medium text-gray-700">Trace Propagation Flow:</div>
            ...
            <div className="mt-4 p-3 bg-blue-50 text-blue-800 rounded text-xs border border-blue-100">
                <strong>Correlation Demo:</strong> All API requests include trace IDs. Check backend logs, Kibana, or Sentry to see the same trace ID across services.
            </div>
        </div>
    );
}
